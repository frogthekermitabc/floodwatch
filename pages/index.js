...
export default function Home() {
    ...
    return (
        <div className="flex flex-col h-screen bg-gray-100">
            ...
            {/* FAB Stack */}
            <div className="absolute bottom-32 md:bottom-24 right-4 z-[1000] flex flex-col space-y-3 items-end">
                {/* Alerts FAB */}
                {permission === 'default' && (
                    <button
            ...
            {/* Visitor Counter */}
            <div className="absolute top-20 right-4 md:top-auto md:right-auto md:bottom-16 md:left-4 z-[1000] bg-black/80 backdrop-blur-sm px-2 py-1 md:p-3 rounded shadow-lg border border-gray-700">
